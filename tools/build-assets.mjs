 ...
 *
 * The theme enqueues the .min files and falls back to the readable sources when
...
const targets = [
	{ from: 'assets/css/theme.css', to: 'assets/css/theme.min.css', minify: minifyCss },
	{ from: 'assets/css/editor.css', to: 'assets/css/editor.min.css', minify: minifyCss },
	{ from: 'assets/js/philosophy-blocks.js', to: 'assets/js/philosophy-blocks.min.js', minify: minifyJs }
];

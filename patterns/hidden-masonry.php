...
<div class="wp-block-query philosophy-masonry">
	<!-- wp:post-template {"className":"philosophy-masonry__list","layout":{"type":"grid","minimumColumnWidth":"320px"}} -->
		<!-- wp:group {"className":"philosophy-masonry__brick","style":{"spacing":{"blockGap":"var:preset|spacing|30","padding":{"bottom":"var:preset|spacing|40"}}},"layout":{"type":"default"}} -->
		<div class="wp-block-group philosophy-masonry__brick" style="padding-bottom:var(--wp--preset--spacing--40)">
			<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"4/3","className":"philosophy-masonry__thumb"} /-->
			...
			<!-- wp:read-more {"content":"<?php echo esc_attr__( 'Read More', 'philosophy-blocks' ); ?>","fontFamily":"sans","fontSize":"x-small"} /-->
